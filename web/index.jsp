    ...
    <body class="js">
        ...
        <header class="header shop">
            ...
            <script>
                ...
                var element = document.getElementById('img-slider');
                var child = element.children[0];
                var img = child.children;
                console.log(img.length);
                for (var i = 0; i < img.length; i++) {
                    img[i].setAttribute("class", "slider-image");
                }
                    ...
                    <c:forEach var="b" items="${newests}">
                        <div class="col-lg-4 col-md-6 col-12">
                            ...
                            <div class="shop-single-blog">
                                <a class="image" href="blog-detail/${b.getTitle().replaceAll("[\\s]","-")}"><div >  <img src="newsImage/${b.getImage()}" alt="#"></div></a>
                                <div class="content">
