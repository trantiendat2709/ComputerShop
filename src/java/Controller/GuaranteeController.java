...
public class GuaranteeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            int size = gdb.getSizeOfList(request.getParameter("key"));
            ...
            List<Guarantee> list = gdb.getListByPage(start, numperpage, request.getParameter("key"));
            ...
            session.setAttribute("listGuarantee", list);
